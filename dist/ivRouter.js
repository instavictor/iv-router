...
var RouterUtils = {
  ...
  */
  extractSlug: function extractSlug(url) {
    ...
    var slug = url.substring(0, keyLength) || null;
  ...
  */
  function IVRouter(routes) {
    ...
    for (var i = 0; i < routeKeys.length; i++) {
      ...
      var key = _utils2.default.extractSlug(routeKeys[i]);
      ...
      if (key) {
        ...
        this._routes[key].push({
          keyDefs: routeKeys[i],
          regex: _utils2.default.convertRouteToRegex(routeKeys[i]),
